...
public class CodeMakeTool {
	...
	public static void main(String[] args) throws Exception {
		...
		cop.simpleClassNames = new String[]{
				"Concept", 
				"Node", 
				"Entity", 
				"Driver",
		...
		cop.prefix = "Ether";
		cop.path = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/ether/ether-0/ether-0.2/projects/soil/soil-0/soil-0.1/org.ghcc.toft-ware.core.impl.ether-soil-0.1-0.2-0.1/java-code";
...
//				"Output"
		...
		caas.prefix = "Ether";
		caas.path = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/ether/ether-0/ether-0.2/projects/soil/soil-0/soil-0.1/org.ghcc.toft-ware.core.impl.ether-soil-0.1-0.2-0.1/java-code";
		...
		matrix.importPackage = "org.ghcc.toft.ware.core.design.matrix";
		matrix.prefix = "Ether";
		matrix.superPrefix = "";
		matrix.path = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/ether/ether-0/ether-0.2/projects/soil/soil-0/soil-0.1/org.ghcc.toft-ware.core.impl.ether-soil-0.1-0.2-0.1/java-code";
		...
		abstractMatrix.path = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/ether/ether-0/ether-0.2/projects/soil/soil-0/soil-0.1/org.ghcc.toft-ware.core.impl.ether-soil-0.1-0.2-0.1/java-code";
		...
		defaultMatrix.path = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/ether/ether-0/ether-0.2/projects/soil/soil-0/soil-0.1/org.ghcc.toft-ware.core.impl.ether-soil-0.1-0.2-0.1/java-code";
...
" *\r\n" +
" */\r\n" +
"import " + javaCodeInfo.getSuperFullClassName(j, i) + ";\r\n" +
"import " + javaCodeInfo.combineCodeInfo[0].getThisFullClassName(j) + ";\r\n" +
"import " + javaCodeInfo.combineCodeInfo[1].getThisFullClassName(i) + ";\r\n" +
"\r\n" +
"" + javaCodeInfo.getClassHeaerPrefix() + " " + fileName + " " + javaCodeInfo.extends_or_implements + " " + javaCodeInfo.getSuperClassName(j, i) + ", " + javaCodeInfo.combineCodeInfo[0].getThisClassName(j) + ", " + javaCodeInfo.combineCodeInfo[1].getThisClassName(i)  + " {\r\n\r\n}" +
"");
					write.flush();
					write.close();
					System.out.println(file);
