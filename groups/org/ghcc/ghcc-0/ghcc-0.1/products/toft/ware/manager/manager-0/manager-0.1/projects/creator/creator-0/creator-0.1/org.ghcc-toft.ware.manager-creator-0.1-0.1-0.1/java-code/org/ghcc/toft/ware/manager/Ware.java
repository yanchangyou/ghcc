...
public class Ware {
	...
	public Ware(URL rootURL, String wareID){
...
//			new File(URLDecoder.decode(this.rootURL.toString(), "UTF-8"));
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(new URL("file://l:/ghcc/svn/groups").toExternalForm());
		System.out.println(new URL("file://l:/ghcc/svn/groups").toString());
		System.out.println(url.getProtocol());
		System.out.println(new File(url.toString().substring("file://".length())).getCanonicalPath());
