package org.ghcc.toft.ware.core.impl.util;
 ...
 * @version 0.3
 */
public class AbtractCodeMachine {
	static SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	static String PROJECT_NAME = "org.ghcc.toft-ware.core.impl.dom4j-revolution-0.1-1-1";
	static String VERSION = "0.1-1-1";
	static String PATH = "L:/ghcc/svn/groups/org/ghcc/toft/toft-0/toft-0.1/products/ware/core/impl/dom4j/dom4j-1/projects/revolution/revolution-1/org.ghcc.toft-ware.core.impl.dom4j-revolution-0.1-1-1/java-code";
	/**
	 * 
	 * @param args
	 * @throws Exception 
	...
	private static JavaClass[] makeMopJavaCode(JavaClass[] caas, JavaClass[] cop) throws Exception {
		...
		for (int i = 0; i < caas.length; i++) {
			for (int j = 0; j < cop.length; j++) {
				classNameArray[classIndex ++] = "Abstract" + caas[i].className + cop[j].className;
				packageNameArray[packageIndex ++] = "org.ghcc.toft.ware.core.impl.dom4j.abstracts.mop.caas" + "." + caas[i].className.toLowerCase() + cop[j].packageName.substring("org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop".length());
			}
		}
...
//				javaClassArray[classIndex].importClassFullName[1] = cop[j].getClassFullName();
				javaClassArray[classIndex].implementsClassName = new String[1];
				javaClassArray[classIndex].implementsClassName[0] = javaClassArray[classIndex].className.replaceAll("Abstract", "");

				javaClassArray[classIndex].importClassFullName = new String[1];
				javaClassArray[classIndex].importClassFullName[0] = javaClassArray[classIndex].packageName.replaceAll("impl.dom4j.abstracts", "design.interfaces") + "." + javaClassArray[classIndex].implementsClassName[0];
	...
	private static JavaClass[] makeCaasJavaCode() throws Exception {
		...
		String[] caasPackageNameArray = new String[]{
				//caas
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.concept.caas",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.concept.caas",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.concept.caas",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.concept.caas",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.concept.caas",
...
//					" * @since " + PROJECT_NAME + "\r\n" +
					" *\r\n" +
					" */\r\n";
			javaClassArray[i].classSign = "public class";
	...
	private static JavaClass[] makeCOPJavaCode() throws IOException {
		...
		String[] copPackageNameArray = new String[]{
				...
				//define
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.define",
				//exception
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.exception",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.exception",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.exception",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.exception",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.exception",
				//lifecycle
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.lifecycle",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.lifecycle",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.lifecycle",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.lifecycle",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop.lifecycle",
				//cop
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop",
				"org.ghcc.toft.ware.core.impl.dom4j.abstracts.cop",
		};
//		String[][] methodNameArray = new String[][]{
...
class JavaClass extends JavaCode {
	...
	for (int i = 0; i < importClassFullName.length; i++) {
		...
		code += "" + classComment + "\r\n";
		code += "\r\n";
		code += "" + classSign + " " + className + getExtendsPart() + getImplementsPart() +  " {\r\n";
